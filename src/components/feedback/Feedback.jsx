      ...
      <div className="container">
        ...
        <div className="feedback__card">
          ...
          <p className="feedback__subtitle">
            Очень повезло оказаться именно в эти апартаменты, близость с центром
            очень радует, рядом есть много магазинов
          </p>
        ...
        <div className="feedback__card">
          ...
          <p className="feedback__subtitle">
            Была рада побывать в этих апартаментах, кафешки рядом, пешком можно
            дойти до всех достопримечательностей
          </p>
